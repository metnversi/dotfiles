...
config.font = wezterm.font_with_fallback({
	{ family = "Iosevka Nerd Font", weight = "Light" }, -- Thin, ExtraLight, DemiLight, Light, Book, Medium,...
...
config.background = {
	{
		source = {
			--File = "/home/oriana/Pictures/e7/harshetti.png",
			File = "/home/oriana/Pictures/bg.png",
		},
